...
/**
 **STEPS********
     Use FAST/ORB algorithm to detect features in It, and track those features to It+1. A new detection is triggered if the number of features drop below a certain threshold.
...
int main(int argc, char** argv) {
  ...
  cv::namedWindow( "VO output", cv::WINDOW_AUTOSIZE );// Create a window for display.
